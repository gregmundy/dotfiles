...
deploy_file "${REPO_ROOT}/dotfiles/vscode/settings.json" "${VSCODE_USER_DIR}/settings.json"
deploy_file "${REPO_ROOT}/dotfiles/vscode/keybindings.json" "${VSCODE_USER_DIR}/keybindings.json"
